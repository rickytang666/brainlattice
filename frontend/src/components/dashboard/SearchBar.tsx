  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <input
          type="text"
          className="block w-full pl-10 pr-10 py-2 bg-background/60 border border-border rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:border-foreground focus:ring-1 focus:ring-foreground transition-all"
